...
public class StackedScissorCheck
{
    ...
    private static void updateScissor()
    {
        ...
        int scaleFactor = new ScaledResolution(MinecraftClient.getInstance()).getScaleFactor();
        
        GL11.glEnable(GL11.GL_SCISSOR_TEST);
        GL11.glScissor(checkCombination.x * scaleFactor, MinecraftClient.getInstance().displayHeight - (checkCombination.y + checkCombination.height) * scaleFactor, checkCombination.width * scaleFactor, checkCombination.height * scaleFactor);
    }
