...
import peick.scathapro.miscellaneous.sound.ScathaProSound;
...
public abstract class SoundUtil
{
    ...
    {
        MinecraftClient.getInstance().getSoundHandler().playSound(sound);
    }
    ...
    {
        SoundHandler soundHandler = MinecraftClient.getInstance().getSoundHandler();
