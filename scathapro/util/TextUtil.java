...
import peick.scathapro.managers.Config.Key;
import peick.scathapro.miscellaneous.enums.DropMessageRarityMode;
import peick.scathapro.miscellaneous.enums.DropMessageStatsMode;
import peick.scathapro.miscellaneous.enums.Rarity;
...
public abstract class TextUtil
{
    ...
    {
        EntityPlayer player = MinecraftClient.getInstance().thePlayer;
    ...
    {
        MinecraftClient.getInstance().ingameGUI.displayTitle(null, null, -1, -1, -1);
    }
    ...
    {
        FontRenderer fontRenderer = MinecraftClient.getInstance().fontRendererObj;
